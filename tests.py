...
from Neural_Network.activations import softmax, sigmoid, softmax_derivate, sigmoid_derivate, relu, relu_derivate, tanh, tanh_derivate
...
nn = NeuralNetwork()
nn.set(Layer(4, 5, activation=relu, 
                            activation_derivate=tanh_derivate))
